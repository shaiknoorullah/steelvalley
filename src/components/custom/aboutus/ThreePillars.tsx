...
const Card = ({
  ...
  return (
    <div
      ...
      className="border-gradient threePillars border-black/[0.2] group/canvas-card flex items-center justify-center dark:border-gray/[0.2]  max-w-xs w-full mx-auto   h-[30rem] relative"
    >
      <AnimatePresence>
        {hovered && (
          <motion.div
