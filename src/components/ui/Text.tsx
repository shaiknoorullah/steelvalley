...
const TextVariants = tv({
  ...
  variants: {
    variant: {
      ...
      barText: "text-[max(0.5rem,min(1vw,15px))] text-[#ADADAD]",
      heading:
      ...
      theme: "",
      heroTitle: "font-normal text-[#ECECEC]  text-[max(1.2rem,min(3.5vw,65px))]",
      secondaryTitle: "text-[max(1rem,min(2.1vw,45px))] lg:leading-[50px] text-[#ECECEC]",
