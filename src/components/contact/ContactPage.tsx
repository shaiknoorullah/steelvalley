  ...
  return (
    ...
    >
      <Container>
        ...
        {/* INTEGRATION HOOK — do not remove. The orchestrator merge script
            finds [data-pending="quote-builder"] and replaces this entire
            block with the real <QuoteBuilder /> import. */}
        <div
          data-pending="quote-builder"
          role="region"
          aria-label="Quote Builder placeholder"
          className="mt-12 border border-dashed border-[var(--color-ink)]/40 p-12 md:p-16"
          style={{
            background: "rgba(199,205,214,0.18)",
            minHeight: "20rem",
          }}
        >
          <p
            className="max-w-[55ch] opacity-85"
            style={{ fontSize: "1rem", lineHeight: 1.65 }}
          >
            {copy.quoteBuilder.placeholderBody}
          </p>
          <p
            data-component="mono"
            className="sv-mono mt-8 opacity-60"
            style={{ fontSize: "10px" }}
          >
            {copy.quoteBuilder.placeholderMono}
          </p>
        </div>
      </Container>
    </section>
